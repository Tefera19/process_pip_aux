...
# Suggestion to harmonized auxiliary datasets key variable.
# Purpose of this script is harmonized auxiliary data files
# Here are the script for each of the auxiliary datasets that can be run to rename (if necessary) parts of the dataset’s key variables.

# 1- reference year is going to renamed as surveyid_year
...
# cpi_year and cpi_data_level variables is going to renamed as surveyid_year and reporting_level
...
# year and pop_data_level are going to renamed as surveyid_year and reporting_level
...
# year and pce_data_level are going to renamed as surveyid_year and reporting_level
...
# year and gdp_data_level are going to renamed as surveyid_year and reporting_level
...
# pop_data_level is going to renamed as reporting_level
...
# ppp data needs to be filtered by ppp defualt variable and rename ppp_data_level to reporting_level
...
# year is going to renamed as surveyid_year
...
# reporting_year is going to renamed as surveyid_year * if content of the reporting_year
...
# pfw data with other auxiliary datasets. We need to generate reporting level from cpi dataset as follows:
...
# year_data is going to renamed as surveyid_year
